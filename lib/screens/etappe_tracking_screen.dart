  ...
  Future<void> _takePhoto() async {
    try {
      ...
      if (photo != null) {
        ...
        // Bild auch in die Galerie speichern - nur wenn Berechtigung vorhanden
        ...
        // Feedback-Nachricht je nach Erfolg des Galerie-Speicherns
        if (gallerySaved) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
          ...
          // Wenn Berechtigung fehlt, Dialog mit Warnmeldung anzeigen
          if (!hasPhotosPermission) {
            _showPhotoPermissionWarningDialog();
          } else {
            // Berechtigung vorhanden, aber Speichern fehlgeschlagen
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(
