      ...
      child: Column(
        children: [
          ...
          Align(
            alignment: Alignment.centerLeft,
            child: Text(
              'Diese App ist kein Ersatz für das Buch „Mein Weg – Meine Reise". Um sie vollständig zu nutzen, brauchst du das Pilgertagebuch in gedruckter Form. Dort findest du alle Texte, Seiten für Reflexion, thematische Impulse und Zitate.',
              style: TextStyle(
                fontSize: 16,
                color: Theme.of(context).brightness == Brightness.dark
